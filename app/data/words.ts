...
const wordDetails: Record<string, WordDetails> = {
  ...
  "animals-lion": { phonetic: "/ˈlaɪən/", example: "The lion has a big mane.", exampleCn: "狮子有一圈大鬃毛。" },
  "animals-elephant": { phonetic: "/ˈelɪfənt/", example: "The elephant has a long trunk.", exampleCn: "大象有一条长鼻子。" },
  "animals-bear": { phonetic: "/ber/", example: "The bear walks in the forest.", exampleCn: "熊在森林里行走。" },
  "animals-frog": { phonetic: "/frɑːɡ/", example: "The frog can jump high.", exampleCn: "青蛙能跳得很高。" },
  "animals-turtle": { phonetic: "/ˈtɜːrtəl/", example: "The turtle has a hard shell.", exampleCn: "乌龟有一个坚硬的壳。" },
  "fruits-pineapple": { phonetic: "/ˈpaɪnæpəl/", example: "The pineapple is sweet.", exampleCn: "这个菠萝很甜。" },
  "fruits-cherry": { phonetic: "/ˈtʃeri/", example: "The cherry is red.", exampleCn: "这颗樱桃是红色的。" },
  "fruits-kiwi": { phonetic: "/ˈkiːwi/", example: "The kiwi is green inside.", exampleCn: "奇异果里面是绿色的。" },
  "fruits-coconut": { phonetic: "/ˈkoʊkənʌt/", example: "The coconut has white flesh.", exampleCn: "椰子有白色的果肉。" },
  "fruits-blueberry": { phonetic: "/ˈbluːberi/", example: "The blueberry is small and blue.", exampleCn: "这颗蓝莓又小又蓝。" },
  "things-spoon": { phonetic: "/spuːn/", example: "I eat soup with a spoon.", exampleCn: "我用勺子喝汤。" },
  "things-toothbrush": { phonetic: "/ˈtuːθbrʌʃ/", example: "My toothbrush is blue.", exampleCn: "我的牙刷是蓝色的。" },
  "things-umbrella": { phonetic: "/ʌmˈbrelə/", example: "I open my umbrella in the rain.", exampleCn: "下雨时我撑开雨伞。" },
  "things-clock": { phonetic: "/klɑːk/", example: "The clock is on the wall.", exampleCn: "时钟挂在墙上。" },
  "things-doll": { phonetic: "/dɑːl/", example: "The doll has a yellow dress.", exampleCn: "这个玩偶穿着黄色连衣裙。" },
  "body-tooth": { phonetic: "/tuːθ/", example: "This tooth is clean.", exampleCn: "这颗牙齿很干净。" },
  "body-finger": { phonetic: "/ˈfɪŋɡər/", example: "Point with your finger.", exampleCn: "用你的手指指一指。" },
  "body-knee": { phonetic: "/niː/", example: "I bend my knee.", exampleCn: "我弯曲膝盖。" },
  "body-shoulder": { phonetic: "/ˈʃoʊldər/", example: "Touch your shoulder.", exampleCn: "摸一摸你的肩膀。" },
  "body-tongue": { phonetic: "/tʌŋ/", example: "Stick out your tongue.", exampleCn: "伸出你的舌头。" },
  "food-cheese": { phonetic: "/tʃiːz/", example: "The cheese is yellow.", exampleCn: "这块奶酪是黄色的。" },
  "food-soup": { phonetic: "/suːp/", example: "The soup is warm.", exampleCn: "这碗汤是温热的。" },
  "food-pizza": { phonetic: "/ˈpiːtsə/", example: "We share a pizza.", exampleCn: "我们一起分享披萨。" },
  "food-cookie": { phonetic: "/ˈkʊki/", example: "The cookie is round.", exampleCn: "这块饼干是圆形的。" },
  "food-carrot": { phonetic: "/ˈkærət/", example: "The rabbit eats a carrot.", exampleCn: "兔子吃胡萝卜。" },
  "vehicles-scooter": { phonetic: "/ˈskuːtər/", example: "I ride my scooter in the park.", exampleCn: "我在公园骑滑板车。" },
  "vehicles-helicopter": { phonetic: "/ˈhelɪkɑːptər/", example: "The helicopter flies in the sky.", exampleCn: "直升机在天空中飞。" },
  "vehicles-motorcycle": { phonetic: "/ˈmoʊtərsaɪkəl/", example: "The motorcycle has two wheels.", exampleCn: "摩托车有两个轮子。" },
  "vehicles-tractor": { phonetic: "/ˈtræktər/", example: "The tractor works on the farm.", exampleCn: "拖拉机在农场工作。" },
  "vehicles-rocket": { phonetic: "/ˈrɑːkɪt/", example: "The rocket goes into space.", exampleCn: "火箭飞向太空。" },
  "clothes-scarf": { phonetic: "/skɑːrf/", example: "I wear a scarf in winter.", exampleCn: "我冬天戴围巾。" },
  "clothes-gloves": { phonetic: "/ɡlʌvz/", example: "These gloves keep my hands warm.", exampleCn: "这双手套让我的手保持温暖。" },
  "clothes-boots": { phonetic: "/buːts/", example: "My boots are yellow.", exampleCn: "我的靴子是黄色的。" },
  "clothes-pajamas": { phonetic: "/pəˈdʒɑːməz/", example: "I put on my pajamas at night.", exampleCn: "我晚上穿上睡衣。" },
  "clothes-sweater": { phonetic: "/ˈswetər/", example: "This sweater is soft.", exampleCn: "这件毛衣很柔软。" },
  "actions-swim": { phonetic: "/swɪm/", example: "I swim in the pool.", exampleCn: "我在游泳池里游泳。" },
  "actions-dance": { phonetic: "/dæns/", example: "We dance to the music.", exampleCn: "我们跟着音乐跳舞。" },
  "actions-clap": { phonetic: "/klæp/", example: "Clap your hands together.", exampleCn: "拍拍你的双手。" },
  "actions-sing": { phonetic: "/sɪŋ/", example: "I sing a happy song.", exampleCn: "我唱一首快乐的歌。" },
  "actions-cook": { phonetic: "/kʊk/", example: "We cook dinner together.", exampleCn: "我们一起做晚饭。" },
};
...
export const wordCategories: WordCategory[] = [
  makeCategory(
    ...
    [
      ...
      { word: "lion", chinese: "狮子", emoji: "🦁", image: "images/words/animals/lion.webp" },
      { word: "elephant", chinese: "大象", emoji: "🐘", image: "images/words/animals/elephant.webp" },
      { word: "bear", chinese: "熊", emoji: "🐻", image: "images/words/animals/bear.webp" },
      { word: "frog", chinese: "青蛙", emoji: "🐸", image: "images/words/animals/frog.webp" },
      { word: "turtle", chinese: "乌龟", emoji: "🐢", image: "images/words/animals/turtle.webp" },
    ],
  ),
  makeCategory(
    {
    ...
    [
      ...
      { word: "pineapple", chinese: "菠萝", emoji: "🍍", image: "images/words/fruits/pineapple.webp" },
      { word: "cherry", chinese: "樱桃", emoji: "🍒", image: "images/words/fruits/cherry.webp" },
      { word: "kiwi", chinese: "奇异果", emoji: "🥝", image: "images/words/fruits/kiwi.webp" },
      { word: "coconut", chinese: "椰子", emoji: "🥥", image: "images/words/fruits/coconut.webp" },
      { word: "blueberry", chinese: "蓝莓", emoji: "🫐", image: "images/words/fruits/blueberry.webp" },
    ],
  ),
  makeCategory(
    {
  ...
  makeCategory(
    ...
    [
      ...
      { word: "spoon", chinese: "勺子", emoji: "🥄", image: "images/words/things/spoon.webp" },
      { word: "toothbrush", chinese: "牙刷", emoji: "🪥", image: "images/words/things/toothbrush.webp" },
      { word: "umbrella", chinese: "雨伞", emoji: "☂️", image: "images/words/things/umbrella.webp" },
      { word: "clock", chinese: "时钟", emoji: "🕰️", image: "images/words/things/clock.webp" },
      { word: "doll", chinese: "玩偶", emoji: "🪆", image: "images/words/things/doll.webp" },
    ],
  ),
  makeCategory(
    {
    ...
    [
      ...
      { word: "tooth", chinese: "牙齿", emoji: "🦷", image: "images/words/body/tooth.webp" },
      { word: "finger", chinese: "手指", emoji: "☝️", image: "images/words/body/finger.webp" },
      { word: "knee", chinese: "膝盖", emoji: "🦵", image: "images/words/body/knee.webp" },
      { word: "shoulder", chinese: "肩膀", emoji: "🙋", image: "images/words/body/shoulder.webp" },
      { word: "tongue", chinese: "舌头", emoji: "👅", image: "images/words/body/tongue.webp" },
    ],
  ),
  makeCategory(
    {
  ...
  makeCategory(
    ...
    [
      ...
      { word: "cheese", chinese: "奶酪", emoji: "🧀", image: "images/words/food/cheese.webp" },
      { word: "soup", chinese: "汤", emoji: "🥣", image: "images/words/food/soup.webp" },
      { word: "pizza", chinese: "披萨", emoji: "🍕", image: "images/words/food/pizza.webp" },
      { word: "cookie", chinese: "饼干", emoji: "🍪", image: "images/words/food/cookie.webp" },
      { word: "carrot", chinese: "胡萝卜", emoji: "🥕", image: "images/words/food/carrot.webp" },
    ],
  ),
  makeCategory(
    {
    ...
    [
      ...
      { word: "scooter", chinese: "滑板车", emoji: "🛴", image: "images/words/vehicles/scooter.webp" },
      { word: "helicopter", chinese: "直升机", emoji: "🚁", image: "images/words/vehicles/helicopter.webp" },
      { word: "motorcycle", chinese: "摩托车", emoji: "🏍️", image: "images/words/vehicles/motorcycle.webp" },
      { word: "tractor", chinese: "拖拉机", emoji: "🚜", image: "images/words/vehicles/tractor.webp" },
      { word: "rocket", chinese: "火箭", emoji: "🚀", image: "images/words/vehicles/rocket.webp" },
    ],
  ),
  makeCategory(
    {
    ...
    [
      ...
      { word: "scarf", chinese: "围巾", emoji: "🧣", image: "images/words/clothes/scarf.webp" },
      { word: "gloves", chinese: "手套", emoji: "🧤", image: "images/words/clothes/gloves.webp" },
      { word: "boots", chinese: "靴子", emoji: "🥾", image: "images/words/clothes/boots.webp" },
      { word: "pajamas", chinese: "睡衣", emoji: "🌙", image: "images/words/clothes/pajamas.webp" },
      { word: "sweater", chinese: "毛衣", emoji: "🧶", image: "images/words/clothes/sweater.webp" },
    ],
  ),
  makeCategory(
    {
    ...
    [
      ...
      { word: "swim", chinese: "游泳", emoji: "🏊", image: "images/words/actions/swim.webp" },
      { word: "dance", chinese: "跳舞", emoji: "💃", image: "images/words/actions/dance.webp" },
      { word: "clap", chinese: "拍手", emoji: "👏", image: "images/words/actions/clap.webp" },
      { word: "sing", chinese: "唱歌", emoji: "🎤", image: "images/words/actions/sing.webp" },
      { word: "cook", chinese: "做饭", emoji: "🧑‍🍳", image: "images/words/actions/cook.webp" },
    ],
  ),
  makeCategory(
    {
